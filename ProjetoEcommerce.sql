...
alter table usuario add column user_tx_email varchar(50);
...
alter table estado rename column est_char_pais to est_tx_pais; 
...
alter table cliente drop column cli_tx_email;
alter table cliente drop column cli_tx_endereco;
...
insert into usuario (user_tx_nome, user_tx_cpf, user_tx_senha, user_tx_email) values 
	('Lucas Latsch', '12345678911', '123', 'lucas@debeats.com');
insert into usuario (user_tx_nome, user_tx_cpf, user_tx_senha, user_tx_email) values 
...
insert into cliente (cli_tx_nomeusu, cli_dt_datanasc, fk_user_cd_id, fk_end_cd_id) values 
	('LucasLatsch', to_date('1996-10-16','yyyy-mm-dd'), 1, 2);

-- inserindo funcionario
insert into funcionario (fk_user_cd_id) values (2);

-- inserindo categorias
insert into categoria (cat_tx_nome, cat_tx_descricao) values 
('Violões','O mais popular dos instrumentos...'),
('Guitarras','Solos e harmonias marcantes nos mais diferentes ..'),
('Baixo', 'Opções para a linha base da banda'),
('Bateria e percursão','Membranas vibrantes que fazem nosso coração pulsar'),
('Periféricos','Caixas de som, cabos e tudo para completar seu set'),
...
-- inserindo produtos
-- ajustar o valor dos produtos de int para decimal
...
('Stratocaster', 'Clássica e versátil',20,to_date('2023-08-15','yyyy-mm-dd'), 500, 1, 2),
('Les Paul', 'Captadores duplos e som encorpado',20,to_date('2023-08-15','yyyy-mm-dd'), 700, 1, 2),
('SG', 'Hard rock até no design',20,to_date('2023-08-15','yyyy-mm-dd'), 700, 1, 2),
('Baixo Acústico', 'Um baixo, só que acústico,',20,to_date('2023-08-15','yyyy-mm-dd'), 500, 1, 3),
('Baixolão', 'Captadores duplos e som encorpado',20,to_date('2023-08-15','yyyy-mm-dd'), 700, 1, 3),
('Baixo 5 Cordas', 'Contrabaixo de cinco cordas',20,to_date('2023-08-15','yyyy-mm-dd'), 700, 1, 3),
('Bateria Standart', 'Set básico de bateria',20,to_date('2023-08-15','yyyy-mm-dd'), 2000, 1, 4),
('Bateria Elétrica', 'Set silencioso para bateristas de apartamento',20,to_date('2023-08-15','yyyy-mm-dd'), 3000, 1, 4),
('Pandeiro', 'Do partido alto ao choro',20,to_date('2023-08-15','yyyy-mm-dd'), 100, 1, 4),
('Amplicador 500W', 'Cubo para pequenas audiências',20,to_date('2023-08-15','yyyy-mm-dd'), 300, 1, 5),
('Microfone', 'Um vocalista também tem seu instrumento',20,to_date('2023-08-15','yyyy-mm-dd'), 150, 1, 5),
('Pedaleira', 'Para guitarristas exigentes (e exibidos)',20,to_date('2023-08-15','yyyy-mm-dd'), 450, 1, 5),
('Teclado', 'Ideal para aulas de canto',20,to_date('2023-08-15','yyyy-mm-dd'), 300, 1, 6),
('Acordeon', 'Dizem ser o mais difícil dos instrumentos',20,to_date('2023-08-15','yyyy-mm-dd'), 150, 1, 6),
('Banjo', 'Ocê sabe usá isso?',20,to_date('2023-08-15','yyyy-mm-dd'), 300, 1, 7),
('Cavaco', 'Vem com a skin pagode 90s',20,to_date('2023-08-15','yyyy-mm-dd'), 300, 1, 7),
('Violino', 'Refinado como uma tarde na Toscana',20,to_date('2023-08-15','yyyy-mm-dd'), 1000, 1, 7),
('Cabo 3m', 'Cabo com plug banana de 3m de comprimento.',20,to_date('2023-08-15','yyyy-mm-dd'), 20, 1, 8),
('Palheta', 'Chega de usar moedas e lixar as unhas.',20,to_date('2023-08-15','yyyy-mm-dd'), 1, 1, 8),
...
('Débito', '1234123412341234', 1, to_date('2023-08-16','yyyy-mm-dd') ),
('Crédito', '1234123412341234', 1, to_date('2023-08-16','yyyy-mm-dd') ),
('PIX', ' ', 1, to_date('2023-08-16','yyyy-mm-dd') ),
('Dinheiro', ' ', 1, to_date('2023-08-16','yyyy-mm-dd') );
...
insert into pedido_produto (fk_pro_cd_id, fk_ped_cd_id) values 
	(10,1),
	(19,1);
update pedido_produto set pedpro_int_quantidade = 1 where pedpro_cd_id < 3;
